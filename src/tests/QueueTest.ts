import { Deque, PriorityQueue, Queue } from "../data_structures/Queue";

export class QueueTest extends eui.Component implements eui.UIComponent {
    ...
    childrenCreated() {
        ...
        const palindromeChecker = (aString: string): boolean => {
            ...
            const lowerString = aString.toLocaleUpperCase().split(' ').join('');
            let isEqual = true;
